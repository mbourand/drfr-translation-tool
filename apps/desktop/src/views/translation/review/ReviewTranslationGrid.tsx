...
export const ReviewTranslationGrid = ({
  ...
  // Staged-but-unsent screenshots, keyed by line, held here (like the text drafts) so they survive the
  // cell renderer being torn down and recreated as the grid scrolls.
