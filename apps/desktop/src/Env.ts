...
const ENV_VARIABLES = {
  ...
  VITE_GITHUB_BASE_BRANCH: ENV_STRING,
  VITE_GITHUB_BETA_BRANCH: ENV_STRING
} as const
...
export const ENV = {
  ...
  GITHUB_BASE_BRANCH: getValue('VITE_GITHUB_BASE_BRANCH'),
  GITHUB_BETA_BRANCH: getValue('VITE_GITHUB_BETA_BRANCH')
